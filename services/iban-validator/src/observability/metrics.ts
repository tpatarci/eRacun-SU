/**
 * Prometheus Metrics for IBAN Validator Service
 */
...
export const validationCounter = new Counter({
  name: 'iban_validations_total',
  help: 'Total number of IBAN validations performed',
  labelNames: ['result', 'source'],
  registers: [register],
});

export const validationDuration = new Histogram({
  name: 'iban_validation_duration_seconds',
  help: 'Duration of IBAN validation in seconds',
  labelNames: ['result'],
...
export const batchValidationCounter = new Counter({
  name: 'iban_batch_validations_total',
  help: 'Total number of batch IBAN validations performed',
  labelNames: ['source'],
  registers: [register],
});

export const batchValidationSize = new Histogram({
  name: 'iban_batch_validation_size',
